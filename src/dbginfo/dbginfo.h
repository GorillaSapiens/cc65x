...
/* C symbol kinds */
typedef enum { CC65_CSYM_FUNC, CC65_CSYM_VAR } cc65_csym_kind;
...
const cc65_csyminfo *cc65_cfunc_bymodule(cc65_dbginfo handle,
                                         unsigned module_id);
...
const cc65_lineinfo *cc65_line_bynumber(cc65_dbginfo handle, unsigned source_id,
                                        cc65_line line);
...
const cc65_lineinfo *cc65_line_bysource(cc65_dbginfo Handle,
                                        unsigned source_id);
// Return line information for a source file. The function returns NULL if the
// file id is invalid.

const cc65_lineinfo *cc65_line_bysymdef(cc65_dbginfo handle,
                                        unsigned symbol_id);
...
const cc65_lineinfo *cc65_line_bysymref(cc65_dbginfo handle,
                                        unsigned symbol_id);
...
const cc65_scopeinfo *cc65_scope_bymodule(cc65_dbginfo handle,
                                          unsigned module_id);
...
const cc65_symbolinfo *cc65_symbol_byname(cc65_dbginfo handle,
                                          const char *name);
