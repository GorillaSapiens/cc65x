...
{
   static const char *const NameList[] = {"format"};
...
// Read an input file
{
   static const char *const NameList[] = {"name", "format"};
...
// Generate a slice of a bitmap
{
   ...
   if (W > BM_MAX_WIDTH || H > BM_MAX_HEIGHT || X + W > GetBitmapWidth(C) ||
...
{
   static const char *const NameList[] = {"target", "name", "format"};
