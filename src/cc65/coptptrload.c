   ...
   while (I < CS_GetEntryCount(S)) {
      ...
      if (L[0]->OPC == OP65_CLC && CS_GetEntries(S, L + 1, I + 1, 8) &&
          ...
          (L[1]->AM == AM65_ABS || L[1]->AM == AM65_ZP ||
           L[1]->AM == AM65_IMM) &&
          L[2]->OPC == OP65_TAY && L[3]->OPC == OP65_TXA &&
          L[4]->OPC == OP65_ADC && L[5]->OPC == OP65_TAX &&
          L[6]->OPC == OP65_TYA && L[7]->OPC == OP65_LDY &&
          CE_IsKnownImm(L[7], 0) && CE_IsCallTo(L[8], "ldauidx") &&
         ...
         if ((P = CS_GetPrevEntry(S, I)) != 0 && P->OPC == OP65_LDX &&
             !CE_HasLabel(P)) {
...
// lda     (ptr1),y
{
   ...
   while (I < CS_GetEntryCount(S)) {
      ...
      /* Check for the sequence */
      if (L[0]->OPC == OP65_ADC && CS_GetEntries(S, L + 1, I + 1, 8) &&
          L[1]->OPC == OP65_PHA && L[2]->OPC == OP65_TXA &&
          L[3]->OPC == OP65_INY && L[4]->OPC == OP65_ADC &&
          L[5]->OPC == OP65_TAX && L[6]->OPC == OP65_PLA &&
          L[7]->OPC == OP65_LDY && CE_IsCallTo(L[8], "ldauidx") &&
          !CS_RangeHasLabel(S, I + 1, 8)) {
...
// lda     label,y
{
   ...
   while (I < CS_GetEntryCount(S)) {
      ...
      /* Check for the sequence */
      if (L[0]->OPC == OP65_LDA && L[0]->AM == AM65_IMM &&
          CS_GetEntries(S, L + 1, I + 1, 7) && L[1]->OPC == OP65_LDX &&
          L[1]->AM == AM65_IMM && L[2]->OPC == OP65_CLC &&
          L[3]->OPC == OP65_ADC &&
          (L[3]->AM == AM65_ABS || L[3]->AM == AM65_ZP) &&
          (L[4]->OPC == OP65_BCC || L[4]->OPC == OP65_JCC) &&
          L[4]->JumpTo != 0 && L[4]->JumpTo->Owner == L[6] &&
          L[5]->OPC == OP65_INX && L[6]->OPC == OP65_LDY &&
          CE_IsKnownImm(L[6], 0) && CE_IsCallTo(L[7], "ldauidx") &&
          !CS_RangeHasLabel(S, I + 1, 5) && !CE_HasLabel(L[7]) &&
          /* Check the label last because this is quite costly */
          (Len = strlen(L[0]->Arg)) > 3 && L[0]->Arg[0] == '<' &&
          L[0]->Arg[1] == '(' && strlen(L[1]->Arg) == Len &&
          L[1]->Arg[0] == '>' &&
...
// lda     label,y
{
   ...
   while (I < CS_GetEntryCount(S)) {
      ...
      /* Check for the sequence */
      if (L[0]->OPC == OP65_LDA && L[0]->AM == AM65_IMM &&
          CS_GetEntries(S, L + 1, I + 1, 8) && L[1]->OPC == OP65_LDX &&
          L[1]->AM == AM65_IMM && !CE_HasLabel(L[1]) && L[2]->OPC == OP65_LDY &&
          CE_IsConstImm(L[2]) && !CE_HasLabel(L[2]) && L[3]->OPC == OP65_CLC &&
          !CE_HasLabel(L[3]) && L[4]->OPC == OP65_ADC &&
          L[4]->AM == AM65_ZP_INDY && !CE_HasLabel(L[4]) &&
          (L[5]->OPC == OP65_BCC || L[5]->OPC == OP65_JCC) &&
          L[5]->JumpTo != 0 && L[5]->JumpTo->Owner == L[7] &&
          !CE_HasLabel(L[5]) && L[6]->OPC == OP65_INX && !CE_HasLabel(L[6]) &&
          L[7]->OPC == OP65_LDY && CE_IsKnownImm(L[7], 0) &&
          CE_IsCallTo(L[8], "ldauidx") && !CE_HasLabel(L[8]) &&
          /* Check the label last because this is quite costly */
          (Len = strlen(L[0]->Arg)) > 3 && L[0]->Arg[0] == '<' &&
          L[0]->Arg[1] == '(' && strlen(L[1]->Arg) == Len &&
          L[1]->Arg[0] == '>' &&
...
// lda     (ptr1),y
{
   ...
   while (I < CS_GetEntryCount(S)) {
      ...
      /* Check for the sequence */
      if (CE_IsCallTo(L[0], "pushax") && CS_GetEntries(S, L + 1, I + 1, 5) &&
          L[1]->OPC == OP65_LDX && CE_IsKnownImm(L[1], 0) &&
          L[2]->OPC == OP65_LDA &&
          (L[2]->AM == AM65_ABS || L[2]->AM == AM65_ZP ||
           L[2]->AM == AM65_IMM) &&
          CE_IsCallTo(L[3], "tosaddax") && L[4]->OPC == OP65_LDY &&
          CE_IsKnownImm(L[4], 0) && CE_IsCallTo(L[5], "ldauidx") &&
...
// lda     (ptr1),y
{
   ...
   while (I < CS_GetEntryCount(S)) {
      ...
      /* Check for the sequence */
      if (CE_IsCallTo(L[0], "pushax") && CS_GetEntries(S, L + 1, I + 1, 6) &&
          L[1]->OPC == OP65_LDY && CE_IsConstImm(L[1]) && L[1]->Num >= 2 &&
          L[2]->OPC == OP65_LDX && CE_IsKnownImm(L[2], 0) &&
          L[3]->OPC == OP65_LDA && L[3]->AM == AM65_ZP_INDY &&
          CE_IsCallTo(L[4], "tosaddax") && L[5]->OPC == OP65_LDY &&
          CE_IsKnownImm(L[5], 0) && CE_IsCallTo(L[6], "ldauidx") &&
          !CS_RangeHasLabel(S, I + 1, 6) && !RegYUsed(S, I + 7)) {
...
// lda     (ptr1),y
{
   ...
   while (I < CS_GetEntryCount(S)) {
      ...
      if (L[0]->OPC == OP65_JSR &&
          ...
          CS_GetEntries(S, L + 1, I + 1, 9) && L[1]->OPC == OP65_CLC &&
          L[2]->OPC == OP65_ADC && L[3]->OPC == OP65_TAY &&
          L[4]->OPC == OP65_TXA && L[5]->OPC == OP65_ADC &&
          L[6]->OPC == OP65_TAX && L[7]->OPC == OP65_TYA &&
          L[8]->OPC == OP65_LDY && CE_IsCallTo(L[9], "ldaxidx") &&
...
// lda     (ptr1),y
{
   ...
   while (I < CS_GetEntryCount(S)) {
      ...
      /* Check for the sequence */
      if (L[0]->OPC == OP65_CLC && CS_GetEntries(S, L + 1, I + 1, 5) &&
          L[1]->OPC == OP65_ADC &&
          (L[1]->AM == AM65_ABS || L[1]->AM == AM65_ZP ||
           L[1]->AM == AM65_IMM) &&
          (L[2]->OPC == OP65_BCC || L[2]->OPC == OP65_JCC) &&
          L[2]->JumpTo != 0 && L[2]->JumpTo->Owner == L[4] &&
          L[3]->OPC == OP65_INX && L[4]->OPC == OP65_LDY &&
          CE_IsKnownImm(L[4], 0) && CE_IsCallTo(L[5], "ldauidx") &&
          !CS_RangeHasLabel(S, I + 1, 3) && !CE_HasLabel(L[5])) {
...
//
{
   ...
   while (I < CS_GetEntryCount(S)) {
      ...
      if (L[0]->OPC == OP65_LDA && L[0]->AM == AM65_ZP &&
          ...
          (Len = strlen(L[0]->Arg)) > 0 && CS_GetEntries(S, L + 1, I + 1, 14) &&
          !CS_RangeHasLabel(S, I + 1, 7) && !CS_RangeHasLabel(S, I + 9, 5) &&
          L[1]->OPC == OP65_LDX && L[1]->AM == AM65_ZP &&
          strncmp(L[1]->Arg, L[0]->Arg, Len) == 0 &&
          strcmp(L[1]->Arg + Len, "+1") == 0 && L[2]->OPC == OP65_STA &&
          L[2]->AM == AM65_ZP && strcmp(L[2]->Arg, "regsave") == 0 &&
          L[3]->OPC == OP65_STX && L[3]->AM == AM65_ZP &&
          strcmp(L[3]->Arg, "regsave+1") == 0 && L[4]->OPC == OP65_CLC &&
          L[5]->OPC == OP65_ADC && CE_IsKnownImm(L[5], 1) &&
          (L[6]->OPC == OP65_BCC || L[6]->OPC == OP65_JCC) &&
          L[6]->JumpTo != 0 && L[6]->JumpTo->Owner == L[8] &&
          L[7]->OPC == OP65_INX && L[8]->OPC == OP65_STA &&
          L[8]->AM == AM65_ZP && strcmp(L[8]->Arg, L[0]->Arg) == 0 &&
          L[9]->OPC == OP65_STX && L[9]->AM == AM65_ZP &&
          strcmp(L[9]->Arg, L[1]->Arg) == 0 && L[10]->OPC == OP65_LDA &&
          L[10]->AM == AM65_ZP && strcmp(L[10]->Arg, "regsave") == 0 &&
          L[11]->OPC == OP65_LDX && L[11]->AM == AM65_ZP &&
          strcmp(L[11]->Arg, "regsave+1") == 0 && L[12]->OPC == OP65_LDY &&
          CE_IsConstImm(L[12]) && CE_IsCallTo(L[13], "ldauidx")) {
...
// lda     (zp),y
{
   ...
   while (I < CS_GetEntryCount(S)) {
      ...
      /* Check for the sequence */
      if (L[0]->OPC == OP65_LDA && L[0]->AM == AM65_ZP &&
          CS_GetEntries(S, L + 1, I + 1, 3) && !CS_RangeHasLabel(S, I + 1, 3) &&
          L[1]->OPC == OP65_LDX && L[1]->AM == AM65_ZP &&
          (Len = strlen(L[0]->Arg)) > 0 &&
          strncmp(L[0]->Arg, L[1]->Arg, Len) == 0 &&
          strcmp(L[1]->Arg + Len, "+1") == 0 && L[2]->OPC == OP65_LDY &&
...
// lda     (zp),y
{
   ...
   while (I < CS_GetEntryCount(S)) {
      ...
      /* Check for the sequence */
      if (L[0]->OPC == OP65_LDA && L[0]->AM == AM65_ZP &&
          CS_GetEntries(S, L + 1, I + 1, 4) && !CS_RangeHasLabel(S, I + 1, 4) &&
          L[1]->OPC == OP65_LDX && L[1]->AM == AM65_ZP &&
          (Len = strlen(L[0]->Arg)) > 0 &&
          strncmp(L[0]->Arg, L[1]->Arg, Len) == 0 &&
          strcmp(L[1]->Arg + Len, "+1") == 0 && (L[2]->Chg & REG_AX) == 0 &&
          L[3]->OPC == OP65_LDY && CE_IsCallTo(L[4], "ldauidx")) {
...
// lda     (zp),y
{
   ...
   while (I < CS_GetEntryCount(S)) {
      ...
      if (CS_GetEntries(S, L, I, 3) && L[0]->OPC == OP65_LDA &&
          L[0]->AM == AM65_ZP && L[1]->OPC == OP65_LDX && L[1]->AM == AM65_ZP &&
          !CS_RangeHasLabel(S, I + 1, 2) && (Len = strlen(L[0]->Arg)) > 0 &&
          strncmp(L[0]->Arg, L[1]->Arg, Len) == 0 &&
...
// This step must be executed *after* OptPtrLoad1!
{
   ...
   while (I < CS_GetEntryCount(S)) {
      ...
      /* Check for the sequence */
      if (L[0]->OPC == OP65_LDY && CS_GetEntries(S, L + 1, I + 1, 1) &&
          CE_IsCallTo(L[1], "ldauidx") && !CE_HasLabel(L[1])) {
...
// the step with less than 200% so it gets executed when -Oi is in effect.
{
   ...
   while (I < CS_GetEntryCount(S)) {
      ...
      /* Check for the sequence */
      if (L[0]->OPC == OP65_LDY && CS_GetEntries(S, L + 1, I + 1, 1) &&
          CE_IsCallTo(L[1], "ldaxidx") && !CE_HasLabel(L[1])) {
...
// Must be run before OptPtrLoad7().
{
   ...
   while (I < CS_GetEntryCount(S)) {
      ...
      /* Check for the sequence */
      if (L[0]->OPC == OP65_LDX && L[0]->AM == AM65_IMM &&
          CS_GetEntries(S, L + 1, I + 1, 7) && L[1]->OPC == OP65_LDA &&
          L[1]->AM == AM65_IMM && L[2]->OPC == OP65_CLC &&
          L[3]->OPC == OP65_ADC &&
          (L[3]->AM == AM65_ABS || L[3]->AM == AM65_ZP) &&
          (L[4]->OPC == OP65_BCC || L[4]->OPC == OP65_JCC) &&
          ...
          !CS_RangeHasLabel(S, I + 1, 5) && !CE_HasLabel(L[7]) &&
          L[0]->Arg[0] == '$' && L[1]->Arg[0] == '$' &&
          strlen(L[0]->Arg) == 3 && strlen(L[1]->Arg) == 3) {
...
// ldx     label+1,y
{
   ...
   while (I < CS_GetEntryCount(S)) {
      ...
      /* Check for the sequence */
      if (L[0]->OPC == OP65_LDX && CE_IsKnownImm(L[0], 0) &&
          CS_GetEntries(S, L + 1, I + 1, 11) && L[1]->OPC == OP65_AND &&
          L[1]->AM == AM65_IMM && CE_HasNumArg(L[1]) && L[1]->Num <= 0x7F &&
          L[2]->OPC == OP65_JSR && L[3]->OPC == OP65_CLC &&
          L[4]->OPC == OP65_ADC && L[5]->OPC == OP65_TAY &&
          L[6]->OPC == OP65_TXA && L[7]->OPC == OP65_ADC &&
          L[8]->OPC == OP65_TAX && L[9]->OPC == OP65_TYA &&
          L[10]->OPC == OP65_LDY && CE_IsKnownImm(L[10], 1) &&
          L[4]->Arg[0] == '<' && L[7]->Arg[0] == '>' && strlen(L[4]->Arg) > 3 &&
          strlen(L[7]->Arg) > 3 && strcmp(L[4]->Arg + 1, L[7]->Arg + 1) == 0 &&
          (strcmp(L[2]->Arg, "aslax1") == 0 ||
           strcmp(L[2]->Arg, "shlax1") == 0) &&
          CE_IsCallTo(L[11], "ldaxidx") && !CS_RangeHasLabel(S, I + 1, 11)) {
