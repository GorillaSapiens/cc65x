   ...
   while (I < CS_GetEntryCount(S)) {
      ...
      if (CS_GetEntries(S, L + 1, I + 1, 12)) {
         ...
         if (/* Check the opcode sequence */
             L[0]->OPC == OP65_LDA && L[1]->OPC == OP65_STA &&
             L[2]->OPC == OP65_LDA && L[3]->OPC == OP65_STA &&
             L[4]->OPC == OP65_LDA && L[5]->OPC == OP65_LDX &&
             L[6]->OPC == OP65_STA && L[7]->OPC == OP65_STX &&
             L[8]->OPC == OP65_LDY && L[9]->OPC == OP65_STY &&
             L[10]->OPC == OP65_LDY && L[11]->OPC == OP65_STY &&
             /* Check the arguments match */
             L[0]->AM == AM65_IMM && !strcmp(L[1]->Arg, "sreg+1") &&
             L[2]->AM == AM65_IMM && !strcmp(L[3]->Arg, "sreg") &&
             L[4]->AM == AM65_IMM && L[5]->AM == AM65_IMM &&
             ...
             !RegXUsed(S, I + 12) && !CS_RangeHasLabel(S, I, 12)) {
   ...
   while (I < CS_GetEntryCount(S)) {
      ...
      if (CS_GetEntries(S, L + 1, I + 1, 12)) {
         ...
         if (L[0]->OPC == OP65_LDA &&
             ...
             L[1]->OPC == OP65_STA && !strcmp(L[1]->Arg, "sreg+1") &&
             L[2]->OPC == OP65_LDA &&
             !strncmp(L[2]->Arg, L[5]->Arg, strlen(L[5]->Arg)) &&
             !strcmp(L[2]->Arg + strlen(L[5]->Arg), "+2") &&
             L[3]->OPC == OP65_STA && !strcmp(L[3]->Arg, "sreg") &&
             L[4]->OPC == OP65_LDX &&
             !strncmp(L[4]->Arg, L[5]->Arg, strlen(L[5]->Arg)) &&
             !strcmp(L[4]->Arg + strlen(L[5]->Arg), "+1") &&
             L[5]->OPC == OP65_LDA && L[6]->OPC == OP65_STA &&
             L[7]->OPC == OP65_STX &&
             !strncmp(L[7]->Arg, L[6]->Arg, strlen(L[6]->Arg)) &&
             !strcmp(L[7]->Arg + strlen(L[6]->Arg), "+1") &&
             L[8]->OPC == OP65_LDY && !strcmp(L[8]->Arg, "sreg") &&
             L[9]->OPC == OP65_STY &&
             !strncmp(L[9]->Arg, L[6]->Arg, strlen(L[6]->Arg)) &&
             !strcmp(L[9]->Arg + strlen(L[6]->Arg), "+2") &&
             L[10]->OPC == OP65_LDY && !strcmp(L[10]->Arg, "sreg+1") &&
             L[11]->OPC == OP65_STY &&
             !strncmp(L[11]->Arg, L[6]->Arg, strlen(L[6]->Arg)) &&
             !strcmp(L[11]->Arg + strlen(L[6]->Arg), "+3") &&
             !RegXUsed(S, I + 11) && !CS_RangeHasLabel(S, I, 12)) {
