...
enum {
   ...
   T_ULONGLONG =
       T_RANK_LONGLONG | T_CLASS_INT | T_SIGN_UNSIGNED | T_SIZE_LONGLONG,
...
// Return true if this is declared as a character type (including
// signed/unsigned). This function is to exclude enums whose underlying types
// are character types.
{
