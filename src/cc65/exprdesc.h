...
#else
#define ED_YetToTest(Expr)                                                     \
   (((Expr)->Flags & (E_NEED_TEST | E_CC_SET)) == E_NEED_TEST)
#endif
...
#else
#define ED_NeedsConst(Expr)                                                    \
   (((Expr)->Flags & E_EVAL_IMMUTABLE_RESULT) == E_EVAL_IMMUTABLE_RESULT)
#endif
...
#else
#define ED_MayHaveNoEffect(Expr)                                               \
   (((Expr)->Flags & E_EVAL_MAYBE_UNUSED) == E_EVAL_MAYBE_UNUSED)
#endif
...
#else
#define ED_PropagateFrom(Expr, SubExpr)                                        \
   (void)((Expr)->Flags |= (SubExpr)->Flags & E_MASK_VIRAL)
#endif
