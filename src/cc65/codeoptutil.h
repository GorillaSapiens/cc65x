...
int LoadAAfter(CodeSeg *S, int Idx, const LoadRegInfo *LRI,
               Collection *Indices);
// Reload into A the same arg according to LoadRegInfo after Idx

int LoadXAfter(CodeSeg *S, int Idx, const LoadRegInfo *LRI,
               Collection *Indices);
// Reload into X the same arg according to LoadRegInfo after Idx

int LoadYAfter(CodeSeg *S, int Idx, const LoadRegInfo *LRI,
               Collection *Indices);
...
int FindArgFirstChangeInOpenRange(CodeSeg *S, int First, int Last,
                                  CodeEntry *E);
...
int FindRegLastChangeInOpenRange(CodeSeg *S, int First, int Last,
                                 unsigned what);
