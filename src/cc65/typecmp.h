...
/* Degree of type compatibility affected by qualifiers as well as some extra
 * info */
typedef enum {
   ...
   TCF_QUAL_IMPLICIT =
       0x08, /* CVR qualifiers of lhs are stricter than those of rhs */
   TCF_MASK_CVR_DIFF = 0x0C, /* All CVR qualifiers */
   TCF_PTR_QUAL_DIFF =
       0x10, /* lhs pointee doesn't have all of CVR qualifiers of rhs pointee */
   TCF_PTR_QUAL_IMPLICIT = 0x20,  /* CVR qualifiers of pointees are stricter on
                                     lhs than those on rhs */
   TCF_MASK_PTR_QUAL_DIFF = 0x30, /* All CVR qualifiers of pointees */
   TCF_ADDRSIZE_QUAL_DIFF = 0x40, /* Address size qualifiers differ */
   TCF_CCONV_QUAL_DIFF =
       0x80, /* Function calling conventions differ. Unused now */
   ...
   TCF_MASK_QUAL =
       TCF_MASK_CVR_DIFF | TCF_MASK_PTR_QUAL_DIFF | TCF_INCOMPATIBLE_QUAL,
} typecmpflag_t;
...
void TypeCompatibilityDiagnostic(const Type *NewType, const Type *OldType,
                                 int IsError, const char *Msg);
