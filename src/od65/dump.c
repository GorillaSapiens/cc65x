...
static void DumpObjHeaderSection(const char *Name, unsigned long Offset,
                                 unsigned long Size)
...
/* Get the export flags as a (static) string */
{
   ...
   switch (Flags & SYM_MASK_TYPE) {
      case SYM_STD:
         strcat(TypeDesc, "SYM_STD");
         break;
      case SYM_CHEAP_LOCAL:
         strcat(TypeDesc, "SYM_CHEAP_LOCAL");
         break;
   }
   ...
   switch (Flags & SYM_MASK_LABEL) {
      case SYM_EQUATE:
         strcat(TypeDesc, ",SYM_EQUATE");
         break;
      case SYM_LABEL:
         strcat(TypeDesc, ",SYM_LABEL");
         break;
   }
   ...
   switch (Flags & SYM_MASK_VAL) {
      case SYM_CONST:
         strcat(TypeDesc, ",SYM_CONST");
         break;
      case SYM_EXPR:
         strcat(TypeDesc, ",SYM_EXPR");
         break;
   }
...
/* Dump the file options */
{
   ...
   for (I = 0; I < Count; ++I) {
      ...
      switch (Type) {
         case OPT_COMMENT:
            TypeDesc = "OPT_COMMENT";
            break;
         case OPT_AUTHOR:
            TypeDesc = "OPT_AUTHOR";
            break;
         case OPT_TRANSLATOR:
            TypeDesc = "OPT_TRANSLATOR";
            break;
         case OPT_COMPILER:
            TypeDesc = "OPT_COMPILER";
            break;
         case OPT_OS:
            TypeDesc = "OPT_OS";
            break;
         case OPT_DATETIME:
            TypeDesc = "OPT_DATETIME";
            break;
         default:
            TypeDesc = "OPT_UNKNOWN";
            break;
      }
