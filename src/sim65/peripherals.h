...
#define PERIPHERALS_COUNTER_LATCH                                              \
   (PERIPHERALS_APERTURE_BASE_ADDRESS +                                        \
    PERIPHERALS_ADDRESS_OFFSET_COUNTER_LATCH)
#define PERIPHERALS_COUNTER_SELECT                                             \
   (PERIPHERALS_APERTURE_BASE_ADDRESS +                                        \
    PERIPHERALS_ADDRESS_OFFSET_COUNTER_SELECT)
#define PERIPHERALS_COUNTER_VALUE                                              \
   (PERIPHERALS_APERTURE_BASE_ADDRESS + PERIPHERALS_ADDRESS_OFFSET_COUNTER)
...
#define PERIPHERALS_SIMCONTROL_CPUMODE                                         \
   (PERIPHERALS_APERTURE_BASE_ADDRESS +                                        \
    PERIPHERALS_SIMCONTROL_ADDRESS_OFFSET_CPUMODE)
#define PERIPHERALS_SIMCONTROL_TRACEMODE                                       \
   (PERIPHERALS_APERTURE_BASE_ADDRESS +                                        \
    PERIPHERALS_SIMCONTROL_ADDRESS_OFFSET_TRACEMODE)
